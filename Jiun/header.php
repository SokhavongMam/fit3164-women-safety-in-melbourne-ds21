...
<html lang="en">
  ...
  <body>
    <div className="App">
        ...
        <a class="navbar-brand" href="./index.php">DS21</a>
        
        <?php
              if (isset($_SESSION["usersuid"])){
                echo "<a href='./emergency2.php' class='btn btn-primary' name='submit'>Emergency Button</a>";
              }
        ?>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav mx-auto" >
            ...
            <li class="nav-item">
              <a class="nav-link" href="./safety_rating.php">
                SAFETY RATING
              </a>
            </li>
            <?php
